...
export default function Contact() {
  return (
    <div className="w-full flex flex-col items-center py-16">
      ...
      <p className="text-lg text-gray-600 max-w-2xl text-center mb-8">Get in touch for inquiries, quotes, or to discuss your next project.</p>
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-4 justify-center">
          <div className="bg-blue-50 rounded-lg p-6">
            <h3 className="font-bold text-blue-800 mb-2">Jay Ambe Construction</h3>
            ...
            <p>Email: <a href="mailto:info@jayambeconstruction.com" className="underline hover:text-blue-700">info@jayambeconstruction.com</a></p>
            <div className="flex space-x-4 mt-4">
              <a href="https://www.instagram.com/jayambeconstruction?igsh=MW5kbGFkZjAxeTQzMQ==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-pink-500 flex items-center">
              ...
              <a href="https://www.linkedin.com/company/jay-ambe-construction-04/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-blue-500 flex items-center">
              ...
              <a href="https://www.facebook.com/share/19BFZS4dnL/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-blue-700 flex items-center">
          ...
          <div className="bg-gray-200 rounded-lg h-40 flex items-center justify-center text-gray-500">Map Placeholder</div>
        </div>
      </div>
    </div>
  );
